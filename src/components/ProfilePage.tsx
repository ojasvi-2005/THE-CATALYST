  ...
  return (
    <div id="profile-page-workspace" className={`h-full w-full overflow-y-auto pb-8 pr-1 space-y-5 select-none ${styles.container}`}>
      ...
      <div className={`flex items-center justify-between ${isSketch ? 'border-2 border-[#111111] rounded-2xl bg-white p-4 shadow-[3px_3px_0px_0px_rgba(17,17,17,1)]' : 'border border-[#E9E4DB] rounded-3xl bg-white p-5 shadow-xs'} shrink-0`}>
        ...
        <button className={`w-10 h-10 ${isSketch ? 'border-2 border-[#111111] rounded-xl bg-white shadow-[2px_2px_0px_0px_rgba(17,17,17,1)]' : 'rounded-2xl border border-[#E9E4DB] bg-white'} flex items-center justify-center`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className={`${isSketch ? 'border-2 border-[#111111] rounded-3xl p-5 bg-white shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]' : 'border border-[#E9E4DB] rounded-3xl p-5 bg-white shadow-xs'} space-y-4 text-left`}>
            
            {/* Avatar & User info */}
            <div className={`flex items-center gap-4 border-b pb-4 ${isSketch ? 'border-dashed border-[#111111]' : 'border-gray-100'}`}>
              <div className={`w-16 h-16 rounded-full ${isSketch ? 'border-2 border-[#111111] bg-[#FAF6F0] shadow-[2px_2px_0px_0px_rgba(17,17,17,1)]' : 'border border-[#E9E4DB] bg-[#FAF8F5]'} overflow-hidden flex items-center justify-center shrink-0`}>
                {userProfilePic ? (
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-500 font-bold mt-1">Stay focused. Grow every day.</p>
              </div>
            </div>

            {/* Mascot Chat Bubble inside profile */}
            <div className={`flex items-center gap-3 bg-[#FAF8F5] ${isSketch ? 'border-2 border-[#111111] rounded-2xl' : 'border border-[#E9E4DB] rounded-3xl'} p-3 relative`}>
              ...
              {isSketch ? (
                ...
                <div className="absolute left-[-8px] top-1/2 -translate-y-1/2 w-0 h-0 border-t-[5px] border-t-transparent border-r-[7px] border-r-[#FAF8F5] border-b-[5px] border-b-transparent filter drop-shadow-[-1px_0_0_#E9E4DB]" />
              )}
              
              <div className="flex-1 min-w-0">
                <span className="text-[8px] font-black uppercase text-gray-500 block">Mascot Greeting</span>
          ...
          <div className={`${isSketch ? 'border-2 border-[#111111] rounded-3xl p-5 bg-white shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]' : 'border border-[#E9E4DB] rounded-3xl p-5 bg-white shadow-xs'} space-y-3 text-left`}>
            <h4 className={`text-[10px] font-black uppercase tracking-wider text-gray-500 border-b pb-1 ${isSketch ? 'border-[#111111]' : 'border-gray-100'}`}>
              Settings Menu
            </h4>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between p-3 rounded-2xl border transition-all text-left cursor-pointer ${
                      isSelected 
                        ...
                        : 'bg-white border-[#E9E4DB] hover:bg-[#FAF8F5]'
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={`text-[9px] font-bold mt-0.5 ${isSelected ? 'opacity-85' : 'text-gray-500'}`}>{item.sub}</p>
                      </div>
                    </div>
        ...
        <div className="lg:col-span-7">
          ...
          <div className={`${isSketch ? 'border-2 border-[#111111] rounded-3xl bg-white shadow-[4px_4px_0px_0px_rgba(17,17,17,1)]' : 'border border-[#E9E4DB] rounded-3xl bg-white shadow-xs'} p-5 space-y-4`}>
            
            {/* Quick Top tabs bar */}
            <div className={`flex ${isSketch ? 'border-2 border-[#111111] rounded-xl' : 'border border-[#E9E4DB] rounded-2xl'} p-1 gap-1 bg-[#FAF8F5]`}>
              {[
              ...
              {activeTab === 'buddy' && (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-bold">Choose your focus buddy or generate a custom one!</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
                    {allCompanions.slice(0, 4).map(companion => {
                      ...
                      return (
                        ...
                        >
                          <div className={`w-10 h-10 rounded-xl overflow-hidden bg-white border flex items-center justify-center ${isSketch ? 'border-2 border-[#111111]' : 'border-[#E9E4DB]'}`}>
                            {companion.svgMarkup ? (
                              <div 
                          ...
                          <div className="w-full mt-1.5">
                            ...
                            <p className="text-[8px] font-bold text-gray-500 truncate">{companion.species}</p>
                          </div>
                        </div>
                      );
                    })}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 font-bold">Change colors and interface presets instantly</p>
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-left min-w-0">
                            ...
                            <p className="text-[9px] text-gray-500 font-bold truncate">{themeItem.text}</p>
                          </div>
                        </div>
                      );
                    })}
                ...
                >
                  {activeSettingsSection === 'account' && (
                    <div className="space-y-3.5">
                      <h4 className={`text-xs font-black uppercase text-gray-500 border-b pb-1 ${isSketch ? 'border-[#111111]' : 'border-gray-100'}`}>Account & Details</h4>
                      
                      <form onSubmit={handleUpdateAccount} className="space-y-3">
                        <div className="space-y-1">
                          <label className="text-[10px] font-black uppercase text-gray-500">Edit Name</label>
                          <input 
                            type="text" 
                            value={nameInput}
                      ...
                      <div className={`space-y-1 pt-2 border-t border-dashed ${isSketch ? 'border-[#111111]' : 'border-gray-100'}`}>
                        ...
                        <div 
                          ...
                          className={`border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-colors ${
                            isDragging 
                              ? isSketch ? 'bg-gray-100 border-[#111111]' : 'bg-[#FAF8EE] border-[#8C9A86]'
                  ...
                  {activeSettingsSection === 'notifications' && (
                    <div className="space-y-4">
                      <h4 className={`text-xs font-black uppercase text-gray-500 border-b pb-1 ${isSketch ? 'border-[#111111]' : 'border-gray-100'}`}>Mute Options</h4>
                      
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-xs font-black">Enable Timer Alarm sound</p>
                            <p className="text-[9px] text-gray-500 font-bold">Plays a soft bell chime when work block ends</p>
                          </div>
                          <button 
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[9px] text-gray-500 font-bold">Shows interactive speech bubbles periodically</p>
                          </div>
                          <button 
                  ...
                  {activeSettingsSection === 'timer' && (
                    <div className="space-y-4">
                      <h4 className={`text-xs font-black uppercase text-gray-500 border-b pb-1 ${isSketch ? 'border-[#111111]' : 'border-gray-100'}`}>Global Timer Intervals</h4>
                      
                      <div className="space-y-2">
                        <div className={`flex justify-between items-center p-3 rounded-xl ${isSketch ? 'bg-[#FAF8F5] border-2 border-[#111111]' : 'bg-[#FAF8F5] border border-[#E9E4DB]'}`}>
                          <div>
                            <p className="text-xs font-black">Customize intervals</p>
                            <p className="text-[9px] text-gray-500 font-bold">Adjust default durations on the Focus Page.</p>
                          </div>
                          <button className={`text-xs font-black px-3 py-1 bg-white hover:bg-gray-50 rounded-lg cursor-pointer ${isSketch ? 'border-2 border-[#111111]' : 'border border-[#E9E4DB]'}`}>
                            Configure
                          </button>
                        </div>
                      </div>
              ...
              {activeTab === 'support' && (
                ...
                >
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-bold">Multi-Theme Responsive Edition v1.2</p>
                  </div>
                  ...
                  <div className={`p-3 rounded-2xl text-[10px] font-bold italic ${isSketch ? 'bg-gray-50 border-2 border-[#111111]' : 'bg-[#FAF8F5] border border-[#E9E4DB]'}`}>
